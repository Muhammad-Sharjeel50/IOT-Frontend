...
const AddCards = ({ icon, title, unit, count, gaugeProps, bgColor }) => {
    
    return (
      <div className="bg-white rounded-lg flex-1 px-3 py-2 flex flex-col items-center h-32 shadow-md" style={{ backgroundColor: bgColor }}>
